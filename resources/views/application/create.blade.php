            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('application.save') }}" class="pt-5">
                        ...
                        <!-- Index Number -->
                        <div class="mb-4 mt-5">
                            <x-label for="index_number" :value="__('Index Number')" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-select id="application_type" class="block mt-1 w-full" name="application_type" required
                                autofocus :value="old('application_type')">
                                <option value=""></option>
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="programme" class="block mt-1 w-full" type="text" name="programme"
                                :value="old('programme')" required autofocus />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="doa" class="block mt-1 w-full" type="date" name="doa" :value="old('doa')"
                                required autofocus />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="doc" class="block mt-1 w-full" type="date" name="doc" :value="old('doc')"
                                required autofocus />
                        </div>
